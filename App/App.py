...
def run():
    ...
    link = '<b>Built with 🤍 by <a href="" style="text-decoration: none; color: #021659;">Pinky Singh</a></b>' 
    ...
    ###### CODE FOR ABOUT PAGE ######
        ...
        <p align="justify">
            Built with 🤍 by 
            <a href="" style="text-decoration: none; color: grey;">Pinky Singh</a>  
    ...
    ###### CODE FOR ADMIN SIDE (ADMIN) ######
        ...
        if st.button('Login'):
            ...
            if ad_user == 'admin' and ad_password == 'admin@resume-analyzer':
                ...
                st.success("Welcome Pinky ! Total %d " % values + " User's Have Used Our Tool : )")                
